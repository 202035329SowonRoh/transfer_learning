...
# Add import statement for SpringStereo Dataset
from spring_dataloader import SpringStereoDataset
...
def get_args_parser():
    ...
    parser.add_argument('--img_height', default=1080, type=int)
    parser.add_argument('--img_width', default=1920, type=int)
    ...
    # Add Spring dataset specific arguments
    parser.add_argument('--spring_root', default='Spring_Dataset/train', type=str,
                        help='root directory of Spring dataset')
...
def main(args):
    ...
    #train_data = build_dataset(args)  # 기존의 데이터셋 빌드 부분
    train_data = SpringStereoDataset(root=args.spring_root, split='train')
